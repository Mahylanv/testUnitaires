    ...
    <footer>
        <img src="../assets/img/footer3.gif" alt="image bg" class="bg">
        <div class="D1">
            <div class="d1">
                <div class="Left">
                    <div class="p1">
                        <ul>
                            <li>
                                <h2 class="Raccourcis">Raccourcis</h2>
                            </li>
                            <li><a href="accueil.php">Accueil</a></li>
                            <li><a href="destination.php">Destination</a></li>
                            <li><a href="#">Hotels</a></li>
                            <li><a href="#">Nos Experiences</a></li>
                    ...
                    <div class="p3">
                        <ul>
                            <li>
                                <h2 class="Service">Service Client</h2>
                            </li>
                ...
                <div class="p4">
                    <ul>
                        <li>
                            <h2 class="Reseaux">Nos Reseaux</h2>
                        </li>
                        <div class="Logo">
            ...
            <div class="d2">
                <p>Imaluu copyright | tous droits réservés - 2023</p>
            </div>
        </div>
    </footer>
