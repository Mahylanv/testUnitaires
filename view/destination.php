...
?>
    ...
    <!-- Affichage des destinations par continent -->
    <div id="parallax-world-of-ugg">
      ...
      <section>
          <div class="parallax-one">
            <h2 class="continent_title">AFRIQUE</h2>
          </div>  
      </section>
      <section>
        <div class="block">
        ...
        <div class="columns mx-1">
          <div class="column is-half is-offset-one-quarter">
            <section>
              <div class="all_card2">
                <?php echo $destination_cards_afrique; ?>
              </div>
            </section>
          </div>
        </div>
      ...
      <section>
        <div class="parallax-two">
          <h2 class="continent_title">AMERIQUE DU NORD</h2>
        </div>
      </section>
      <section>
        <div class="block">
        ...
        <div class="columns mx-1">
          <div class="column is-half is-offset-one-quarter">
            <section>
              <div class="all_card2">
                <?php echo $destination_cards_ameriqueN; ?>
              </div>
            </section>
          </div>
        </div>
      ...
      <section>
        <div class="parallax-three">
          <h2 class="continent_title">AMERIQUE DU SUD</h2>
        </div>
      </section>
      <section>
        <div class="block">
        ...
        <div class="columns mx-1">
          <div class="column is-half is-offset-one-quarter">
            <section>
              <div class="all_card2">
                <?php echo $destination_cards_ameriqueS; ?>
              </div>
            </section>
          </div>
        </div>
      ...
      <section>
        <div class="parallax-four">
          <h2 class="continent_title">ASIE</h2>
        </div>
      </section>
      <section>
        <div class="block">
        ...
        <div class="columns mx-1">
          <div class="column is-half is-offset-one-quarter">
            <section>
              <div class="all_card2">
                <?php echo $destination_cards_asie; ?>
              </div>
            </section>
          </div>
        </div>
      ...
      <section>
        <div class="parallax-five">
          <h2 class="continent_title">EUROPE</h2>
        </div>
      </section>
      <section>
        <div class="block">
        ...
        <div class="columns mx-1">
          <div class="column is-half is-offset-one-quarter">
            <section>
              <div class="all_card2">
                <?php echo $destination_cards_europe; ?>
              </div>
            </section>
          </div>
        </div>
      ...
      <section>
        <div class="parallax-six">
          <h2 class="continent_title">OCEANIE</h2>
        </div>
      </section>
      <section>
        <div class="block">
        ...
        <div class="columns mx-1">
          <div class="column is-half is-offset-one-quarter">
            <section>
              <div class="all_card2">
                <?php echo $destination_cards_oceanie; ?>
              </div>
            </section>
          </div>
        </div>
